...
// import { getCurrentMarkdown, locToEditorPosition } from "utils";




// type CalloutInfo = { cache: SectionCache, settings: MathSettings };
// type EquationInfo = { cache: SectionCache };


// function sortedBlocks<BlockInfo extends { cache: SectionCache }>(
//     cache: CachedMetadata,
//     type: "callout" | "math",
//     addSection: (sections: BlockInfo[], sectionCache: SectionCache) => void,
// ): BlockInfo[] {
...
//             addSection(sections, sectionCache);
//         }
//         sections.sort(
//             (section1, section2) => {
...
// export function sortedMathCallouts(cache: CachedMetadata): CalloutInfo[] {
...
// export function sortedEquations(cache: CachedMetadata): EquationInfo[] {
//     return sortedBlocks<EquationInfo>(
//         cache, "math",
//         (sections, sectionCache) => {
//             let id = sectionCache.id;
//             if (id) {
//                 sections.push(
//                     { cache: sectionCache }
//                 );
...
// export function autoIndex(file: TFile, data: string, cache: CachedMetadata, plugin: MathPlugin) {
