...
export class ExtraSettingsHelper extends SettingsHelper<ExtraSettings> {
    makeSettingPane(): void {
        ...
        this.addDropdownSetting("modifierToPreview", ['Mod', 'Ctrl', 'Meta', 'Shift', 'Alt'], "Modifier key for showing hover preview", "[Incompatible with Hover Editor] Press Enter and this modifier key to show a hover popup preview of the currently selected item. Changing this option requires to reloading " + this.plugin.manifest.name + " to take effect.");
        this.addToggleSetting("compactPreview", "Compact hover preview", "If turned on, the hover preview will be displayed with compact font size.");
